...
func TestStateGenesis(t *testing.T) {
	...
	archiveStore := z.Chain().GetFrontierArchiveStore()
	common.ExpectBytes(t, archiveStore.Identifier().Hash.Bytes(), "0x0385d849ee33b94c8783288c148e3ae741c2ecec98b08b3f59d6bcc219168fe5")
	...
	z.ExpectArchiveFusedAmount(g.User1.Address, 10000*g.Zexp)
}
